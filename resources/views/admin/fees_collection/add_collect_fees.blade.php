                  ...
                  <tbody>
                     @forelse($getFees as $value)
                      <tr>
                          ...
                          <td>Ksh{{ number_format($value->remaning_amount, 2) }}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label class="col-form-label">Total Amount : Ksh{{ number_format($getStudent->amount, 2) }}</label>            
          </div>

          <div class="form-group">
            <label class="col-form-label">Paid Amount : Ksh{{ number_format($paid_amount, 2) }}</label>            
          </div>
          ...
          <div class="form-group">
            ...
            @endphp
            <label class="col-form-label">Remaning Amount : Ksh{{ number_format($RemaningAmount, 2) }}</label>            
          </div>
